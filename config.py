...
BOT_TOKEN = getenv("BOT_TOKEN", "5820073046:AAF5pXdO333nkK8KVjzXNQSTpgjsJTjnPoY")
...
OWNER_ID = getenv("OWNER_ID", "1957296068")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Assistant_Music")
...
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "1957296068").split()))
